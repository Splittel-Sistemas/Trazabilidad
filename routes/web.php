...
Route::post('/Planeacion/partidas/CorteEstatus', [PlaneacionController::class,'CambiarCorteEstatus'])->name('CambiarCorteEstatus')->middleware('auth');
...
Route::post('/Etiquetas/Generar/Campos', [EtiquetasController::class, 'Campos'])->name('Etiquetas.Campos')->middleware('auth');
