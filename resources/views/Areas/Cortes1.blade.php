...
$('#confirmar').click(function () {
    ...
    // Obtener información de la orden de fabricación y validar los cortes
    $.ajax({
        url: url,
        type: 'GET',
        success: function (infoResponse) {
            ...
            // Verificar si los cortes no exceden la cantidad total permitida
            ...
            // Enviar datos para guardar las partidas
            $.ajax({
