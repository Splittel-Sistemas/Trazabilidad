...
<html lang="en-US" dir="ltr">
    <head>
        ...
        <!--    Favicons-->
        <!-- ===============================================-->
        <link rel="apple-touch-icon" sizes="180x180" href="{{asset('menu2/assets/img/favicons/apple-touch-icon.png')}}">
        <link rel="icon" type="image/png" sizes="32x32" href="{{asset('menu2/assets/img/favicons/favicon-32x32.png')}}">
        <link rel="icon" type="image/png" sizes="16x16" href="{{asset('menu2/assets/img/favicons/favicon-16x16.png')}}">
        <link rel="shortcut icon" type="image/x-icon" href="{{asset('menu2/assets/img/favicons/favicon.ico')}}">
                ...
                <div class="navbar-vertical-content">
                    <ul class="navbar-nav flex-column" id="navbarVerticalNav">
                        ...
                        <li class="nav-item"><!-- Areas-->
                            ...
                            <div class="nav-item-wrapper">
                                <a class="nav-link dropdown-indicator label-1" href="#nv-e-areas" role="button" data-bs-toggle="collapse" aria-expanded="false" aria-controls="nv-e-areas">
                                ...
                                <div class="parent-wrapper label-1">
                                    <ul class="nav collapse parent" data-bs-parent="#navbarVerticalCollapse" id="nv-e-areas">
                                        ...
                                        <li class="nav-item"><a class="nav-link" href="{{route('Planeacion')}}" data-bs-toggle="" aria-expanded="false">
                                            <div class="d-flex align-items-center"><span class="nav-link-text">Planeaci&oacute;n</span></div>
                                            </a>
                                        </li>
                                        <li class="nav-item"><a class="nav-link" href="{{route('corte.index')}}" data-bs-toggle="" aria-expanded="false">
                        ...
                        {{--<li class="nav-item">
                            ...
                            <div class="nav-item-wrapper">
                                ...
                                <div class="parent-wrapper label-1">
                                    ...
                                    <li class="collapsed-nav-item-title d-none">Home1</li>
