            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <a href="{{ route('ordenes.index')}}" class="dropdown-toggle"><i class="menu-icon fa fa-cogs"></i>cortes</a>
                        <a href="{{ route('ordenes.index')}}" class="dropdown-toggle"><i class="menu-icon fa fa-cogs"></i>Gestion De Orden De Venta</a>
