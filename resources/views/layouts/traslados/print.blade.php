...
<body>
        ...
        <div class="col-md-12">
            <table class="table table-sm table-borderless">
                <tbody>
                    ...
                    <tr>
                        <td style="padding: 0rem;">Movimiento</td>
                        <td style="padding: 0rem;"># {{$idMovimiento}}</td>
                    </tr>

                    <tr>
                        <td style="padding: 0rem;">Usuario</td>
                        <td style="padding: 0rem;">{{$usuario}}</td>
                    </tr>
    ...
    <table class="table table-sm table-bordered text-center">
        ...
        <tbody>
            @foreach ($listaMovimientos as $numeroMovimiento => $detalle)
            <tr>
                <td>{{ $detalle->ov }}</td>
                <td>{{ $detalle->of }}</td>
                <td>{{ $detalle->rp }}</td>
