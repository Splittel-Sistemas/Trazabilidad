...
$('#ordenFabricacionTable').DataTable({
    ...
    ajax: {
        ...
        dataSrc: function (json) {
            console.log(json);  // Para depurar y verificar la estructura de los datos
            return json.data;  // Asegúrate de que 'data' esté correctamente configurado
        }
    },
    columns: [
        { data: 'id' }, 
        ...
        { data: 'Articulo' },
        {
            data: 'OrdenVenta',  // Accede a la relación 'OrdenVenta'
            render: function(data) {
                // Asegúrate de que 'data' tenga el campo que deseas mostrar
                return data ? data.id : 'N/A';  // Aquí puedes acceder a otros campos de la relación
            }
        }
    ]
});
