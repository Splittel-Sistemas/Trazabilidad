...
@section('content')
    <div class="container">
        <div class="form-container">
            ...
            @endif
            <form id="form-fibra-optica" action="{{ route('ordenes.enviar') }}" method="POST">
                @csrf
                <div class="form-row">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" class="form-control form-control-sm" id="cantidad" name="cantidad" placeholder="Ingrese la cantidad" min="1" required>
                    </div>
                </div>
