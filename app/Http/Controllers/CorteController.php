        ...
        if(!($OrdenFabricacion==null || $OrdenFabricacion=="")){
            ...
            if($PartidasOF->count()==0){
                ...
                foreach($PartidasOF as $partida){
                    ...
                    $Ordenfabricacionpartidas.='<td class="text-center"><button class="btn btn-link me-1 mb-1" onclick="etiquetaColor(\''.$this->funcionesGenerales->encrypt($partida['pivot']->id).'\')" type="button"><i class="fas fa-download"></i></button></td>';
